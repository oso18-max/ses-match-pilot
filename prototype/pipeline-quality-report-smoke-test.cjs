...
assert.equal(normal.queue, 3);
assert.equal(normal.draftProposals, 3);
assert.equal(normal.resolvedQueue, 3);
assert.equal(normal.executed, 0);
assert.equal(normal.skipped, 3);
...
assert.equal(edge.queue, 2);
assert.equal(edge.draftProposals, 2);
assert.equal(edge.resolvedQueue, 2);
assert.equal(edge.executed, 2);
assert.equal(edge.skipped, 0);
